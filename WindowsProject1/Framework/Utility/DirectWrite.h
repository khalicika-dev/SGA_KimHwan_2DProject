...
struct FontBrushDesc
{
	...
	{
		return color.x == value.color.x 
			&& color.y == value.color.y 
			&& color.z == value.color.z
			&& color.w == value.color.w;
	}
};
...
public:
	...
	void RenderText(wstring text, RECT rect, float size,
		DWRITE_TEXT_ALIGNMENT align = DWRITE_TEXT_ALIGNMENT_LEADING,
		wstring font = L"³ª´®¼Õ±Û¾¾ Ææ º¸Åë", Float4 color = Float4(0, 0, 0, 1),
